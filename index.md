...
* 半導体設計会社： SoC・イメージセンサーの映像系インターフェースの機能・性能評価・製品解析
* 半導体商社： FPGAのフィールドサポート

主な著書
* 『100円ショップのガジェットを分解してみる』シリーズ (Part1～Part3)(工学社)
* 『100円ショップガジェット解体新書』(工学社)
...
* 無線マイコン(ESP32)を使用したクラウドファンディング案件(電子回路設計・プリント基板設計・ソフトウエア開発・バック品の製造対応)
